...
export async function handleFeishuMessage(params: {
  ...
  try {
    ...
    // If the message was not queued for background processing,
    // we must clean up the reaction state immediately.
    // If it WAS queued, the reply-dispatcher cleanup will handle it.
    if (!queuedFinal) {
